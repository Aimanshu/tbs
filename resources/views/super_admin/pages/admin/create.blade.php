                    ...
                    <div class="body">
                        ...
                        <form role="form" method="POST" id="AdminformId" action="{{ url('/addrole') }}">
                         {!! csrf_field() !!}
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="number" id="mobile" name="mobile"  value="{{old('mobile')}}"  class="form-control" placeholder="Enter your Mobile Number">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                             ...
                             <label for="password">Select Main Category</label>
                             <div class="form-group">
...
function CheckCategoryAdmin()
{
    ...
    //     });
    // this is before sub category assign To admin
