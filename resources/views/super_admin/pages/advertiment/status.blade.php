<div class="modal fade" id="defaultModal{{$advertiment->id}}" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            
            <div class="modal-body">
                 
                <form role="form" method="POST" action="{{ route('advertiment_status_update', $advertiment->id ) }}">
                        {!! csrf_field() !!}
