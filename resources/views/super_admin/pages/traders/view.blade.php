  ...
  <div class="modal fade" id="myModal{{$trader->id or '-'}}">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <form role="form" method="POST" action="{{ route('update_trader_details', $trader->id) }}" >
        {{ csrf_field() }}
        ...
        <div class="row">
         ...
         <div class="row">
                ...
                <div class="row clearfix">
                    <div class="col-sm-12">
                        <select class="form-control show-tick" id="types_of_business" name="types_of_business">
                          <option  name="types_of_business" value="1">Product</option>
            ...
            <label>Sub Category</label>
                             <div class="row clearfix">
                                <div class="col-sm-12">
                                    <select class="form-control show-tick" id="prod_or_serv_offe" name="prod_or_serv_offe">
