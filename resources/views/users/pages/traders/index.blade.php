    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="row">
            <div class="col-md-4">
                Name: <input type="text"  value="" class="form-control" readonly/>
            </div>
            <div class="col-md-4">
                Email: <input type="email"  value="" class="form-control" readonly/>
            </div>
            <div class="col-md-4">
                Mobile Number: <input type="number"  value="" class="form-control" readonly/>
            </div>
          </div>
          <div class="row">
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                Business Email: <input type="email" value="" class="form-control" readonly/>
            </div>
          </div>

           <div class="row">
            <div class="col-md-4">
               Business Contact No: <input type="number" value="" class="form-control" readonly />
            </div>
            <div class="col-md-4">
                Website: <input type="text"  value="" class="form-control"  readonly />
            </div>
            <div class="col-md-4">
                Location: <input type="text" value="" class="form-control" readonly />
            </div>
          </div>
        
        <div class="row">
            <div class="col-md-4">
               Full Address:  <textarea class="form-group" rows="2" cols="5"  value="" readonly></textarea>
            </div>
            <div class="col-md-4">
