                        ...
                        <table class="table table-hover">
                            ...
                            @php $key++;@endphp
                                <tr>
                                    ...
                                    <td>
                                    @if($proposal->issadmin_approved ==0)         
                                          <button type="button" class="btn btn-success waves-effect m-r-20" data-toggle="modal" data-target="#defaultModal{{$proposal->id}}">Active</button>
                                          @include('admin.pages.enquiry.approve')
                                        @else
                                          <button type="button" class="btn btn-danger waves-effect m-r-20" data-toggle="modal" data-target="#defaultModal{{$proposal->id}}">Deactive</button> 
                                          @include('admin.pages.enquiry.approve')  
                                        @endif
                                    </td>
                                    <td>
