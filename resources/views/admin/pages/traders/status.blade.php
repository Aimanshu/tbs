<div class="modal fade" id="defaultModal{{$trader->trader_profile->user_id}}" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            
            <div class="modal-body">
                 
                <form role="form" method="POST" action="{{ route('traders_status_update', $trader->trader_profile->user_id) }}">
                   {!! method_field('patch') !!}
                        {!! csrf_field() !!}
