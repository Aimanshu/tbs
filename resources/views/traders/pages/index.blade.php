    ...
    <div class="container-fluid">
        <div class="row clearfix">
            ...
            <div class="card">
               <div class="header">
                   &nbsp;&nbsp;&nbsp;&nbsp;
                   <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal{{$traders[0]->id}}">Change Password</button>
                    @include('traders.pages.update_password')
                   &nbsp;&nbsp;&nbsp;&nbsp;
                </div>
            </div>
                <div class="card">
                        ...
                        <table class="table table-hover">
                            ...
                            @foreach($traders as $key => $trader)
                                <tr>
                                    ...
                                    <button type="button" class="btn btn-primary waves-effect m-r-20" data-toggle="modal" data-target="#myModalview{{$trader->id}}">View</button> 
