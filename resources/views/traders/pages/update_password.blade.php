...
<!--vise assign category-->
  <!-- The Modal -->
  <div class="modal fade" id="myModal{{$traders[0]->id or '-'}}">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
      
        <!-- Modal Header -->
        <div class="modal-header" style="background: #a9332b;">
          <h4 class="modal-title" style="color: #fff;font-size: 22px;">Update Password</h4>
          <button type="button" class="close" data-dismiss="modal" style="margin-top: -38px;font-size: 30px;">&times;</button>
        </div>
        <form role="form" method="POST" action="{{ route('change_password', $traders[0]->id) }}">
            {{ csrf_field() }}
        <!-- Modal body -->
        <div class="modal-body">
          ...
          <div class="row">
            <div class="col-sm-12">
                Old Password: <input type="password" name="opassword" id="opassword" value="" class="form-control" />
            </div>
            <div class="col-sm-12">
